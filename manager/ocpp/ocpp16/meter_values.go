...
var enumValues_MeterValuesJsonMeterValueElemSampledValueElemUnit = []interface{}{
	"Wh",
	"kWh",
	"varh",
	"kvarh",
...
var enumValues_MeterValuesJsonMeterValueElemSampledValueElemPhase = []interface{}{
	"L1",
	"L2",
	"L3",
	"N",
...
var enumValues_MeterValuesJsonMeterValueElemSampledValueElemMeasurand = []interface{}{
...
var enumValues_MeterValuesJsonMeterValueElemSampledValueElemLocation = []interface{}{
	"Cable",
	"EV",
	"Inlet",
	"Outlet",
...
const MeterValuesJsonMeterValueElemSampledValueElemUnitVarh MeterValuesJsonMeterValueElemSampledValueElemUnit = "varh"

var enumValues_MeterValuesJsonMeterValueElemSampledValueElemFormat = []interface{}{
	"Raw",
	"SignedData",
}

var enumValues_MeterValuesJsonMeterValueElemSampledValueElemContext = []interface{}{
	"Interruption.Begin",
	"Interruption.End",
	"Sample.Clock",
	"Sample.Periodic",
